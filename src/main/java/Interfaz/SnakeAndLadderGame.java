...
public class SnakeAndLadderGame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        StandardGamePanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, StandardGamePanelLayout.createSequentialGroup()
                .addContainerGap(81, Short.MAX_VALUE)
                .addComponent(CustomGameCreateScreen, javax.swing.GroupLayout.PREFERRED_SIZE, 1521, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        StandardGamePanelLayout.setVerticalGroup(
            StandardGamePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(StandardGamePanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(CustomGameCreateScreen, javax.swing.GroupLayout.PREFERRED_SIZE, 844, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        StandardGameScreenLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, StandardGameScreenLayout.createSequentialGroup()
                ...
                .addGroup(StandardGameScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(StandardDiceLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton2)
                    .addComponent(RollDice, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(30, 30, 30))
        );
...
regreso.setVisible(true);
    ...
    private void CreateStandardBoardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateStandardBoardActionPerformed
        // TODO add your handling code here:
        IniializeIcons();
        Players = new usuario[numOfPlayers];
        if (numOfPlayers == 1) {
            Players[0] = new usuario(1,Player1NameField.getText(),"a", Color.RED);
        } else if (numOfPlayers == 2) {
           Players[0] = new usuario(1,Player1NameField.getText(),"a", Color.RED);
            Players[1] = new usuario(2,Player2NameField.getText(),"a", Color.MAGENTA);
        } else if (numOfPlayers == 3) {
         Players[0] = new usuario(1,Player1NameField.getText(),"a", Color.RED);
            Players[1] = new usuario(2,Player2NameField.getText(),"a", Color.MAGENTA);
                     Players[2] = new usuario(3,Player3NameField.getText(), "c",Color.BLUE);
        }
    ...
    private void RollDiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RollDiceActionPerformed
        // TODO add your handling code here:
        GameControl();
        RollDice.setText(Players[moves % numOfPlayers].getNombre() + " Play");
    ...
    private void RollDice2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RollDice2ActionPerformed
        // TODO add your handling code here:
        GameControl();
        RollDice2.setText(Players[moves % numOfPlayers].getNombre() + " Play");
    ...
    private void CreateCustomBoardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateCustomBoardActionPerformed
        ...
        if (numOfPlayers == 1) {
            ...
            Players[0] = new usuario(1,Player1NameField.getText(),"a" ,Color.RED);
            Players[1] = new usuario(2,Player2NameField.getText(),"b", Color.MAGENTA);
        } else if (numOfPlayers == 3) {
            Players[0] = new usuario(1,Player1NameField.getText(),"q", Color.RED);
            Players[1] = new usuario(2,Player2NameField.getText(),"a", Color.MAGENTA);
            Players[2] = new usuario(3,Player3NameField.getText(), "c",Color.BLUE);
        }
        ...
        Customboxsize = 45;
        Snakes = new Serpiente[Customboardlength * Customboardheight];
        Ladders = new escalera[Customboardlength * Customboardheight];
        moves=0;
        DrawPlayers();
    ...
    private void GameControl(){
        if (GameNotDone()) {
            ...
            moves--;
            int flag=0;
            String a,b=Players[moves % numOfPlayers].getNombre();
            JOptionPane.showMessageDialog(null, Players[moves % numOfPlayers].getNombre() + " has completed the game in " + Integer.toString(Players[moves % numOfPlayers].getPartidasGanadas()) + " moves");
            for(int i=0;i<Winners.size();i++){
                a = ((usuario)Winners.get(i)).getNombre();
                if(a.equals(b)){
                    flag=1;
                    if(((usuario)Winners.get(i)).getPartidasGanadas()> Players[moves % numOfPlayers].getPartidasGanadas()){
                        ...
                        ((usuario)Winners.get(i)).setPartidasGanadas(Players[moves % numOfPlayers].getPartidasGanadas());
                        break;
                    }
                }
            }
            if(flag==0){
                Players[moves % numOfPlayers].setPatidasjugadas(Players[moves % numOfPlayers].getPartidasGanadas());
